    ...
    arrowup: {
        ...
        _do: function(moves){
            ...
            if (!spckeystatus.ctr)
                ...
                zoomMapAssistingNegative(canvas, ctx, spckeystatus.shift ? MOVEPROPERTY.arrowkeys.nosprintratio : MOVEPROPERTY.arrowkeys.ratio, [canvas.width/2, canvas.height/2]);
            return moves;
        },
        _leave: function(){
    ...
    arrowdown: {
        ...
        _do: function(moves){
            ...
            if (!spckeystatus.ctr)
                ...
                zoomMapAssistingNegative(canvas, ctx, spckeystatus.shift ? 1/MOVEPROPERTY.arrowkeys.nosprintratio : 1/MOVEPROPERTY.arrowkeys.ratio, [canvas.width/2, canvas.height/2]);
            return moves;
        },
        _leave: function(){
            _(0, -MOVEPROPERTY.arrowkeys.move*1000/MOVEPROPERTY.arrowkeys.interval);
