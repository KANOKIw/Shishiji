...
execute as @e[tag=small_jerry_will_be_killed, tag=!small_jerry_will_be_killed_scheduled, x=870, y=-100, z=1000, dx=100, dy=500, dz=100] at @s run summon tnt ^ ^ ^2
...
execute as @e[tag=jerry_chine_gun_knockback_dummy, tag=!jerry_chine_gun_knockback_dummy_scheduled] run schedule function sbitems:jerry_chine_gun_dummy_kill 15t append
...
execute as @e[tag=small_jerry_will_be_killed, tag=!small_jerry_will_be_killed_scheduled] run schedule function sbitems:jerry_chine_gun_kill 2t append
