...
execute as @e[tag=on_ether_warp] run effect give @s resistance 1 5 true
...
execute as @e[tag=on_ether_warp] run scoreboard players operation @s mana_current -= @s ether_warp_mana_cost
